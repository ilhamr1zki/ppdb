	 	...
	 	date_default_timezone_set("Asia/Jakarta");
	  	...
	  	if ($foundDataSD == 1) {
	  		...
	  		$queryGetDataAppr = mysqli_query($con, "
		 		...
		 		daily_siswa_approved.from_nip as nip_guru,
...
<script type="text/javascript">
	...
	function showData(roomKey, dailyID, stat, from, dateOri, datePosted, dateAppr, imgUpload, nip, nis, siswa, title, main, reason='ksg') {
